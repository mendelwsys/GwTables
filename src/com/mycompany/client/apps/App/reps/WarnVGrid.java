 ...
 */
public class WarnVGrid extends AReportCreator
{
    ...
    //private String headerURL="WarnVConsHeader.jsp";
...
//    private String dataURL = "transport/dataPlacesCons";
    ...
    public WarnVGrid(String headerURL, String dataURL, IGridMetaProvider gridMetaProvider)
    {
    ...
    public WarnVGrid(IGridMetaProvider gridMetaProvider)
    {
        this.gridMetaProvider = gridMetaProvider;
    }
...
//    }
    ...
    public void setHeaders(final Window portlet, final ListGridWithDesc grid) throws CacheException
    {
        ...
        dataId = dataId.replace("/", "$");
        final Criteria criteria = new Criteria(TablesTypes.TTYPE, TablesTypes.STATEWARNV);
        DataSource.get(dataId).fetchData
        (
            criteria,
            new DSCallback()
                ...
                public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest)
                {
                       ...
                       if (descData!=null && descData.length==1)
                       {
                           try {
                               ...
                               initData(grid,dataCallBack, TablesTypes.STATEWARNV);
                           }
                           finally
                           {
                               completely=true;
...
//        owner.setTitle(title);
    ...
    public String getTitle(String strDate) {
        return "Действующие предупреждения по скоростям на "+strDate;
    }
}
