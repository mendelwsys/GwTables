 ...
 */
public class NewViolInformer extends CreateInformerOperation
{
    public NewViolInformer(int operationId, int parentOperationId, String viewName, TypeOperation type)
    {
        super(operationId, parentOperationId, viewName, type);
    }

    protected NewViolInformer()
    {
    }

    protected IOperation getEmptyObject(DescOperation descOperation)
    {
        return new NewViolInformer();
    }
    ...
    public Canvas operate(Canvas dragTarget, IOperationContext ctx)
    {
        ...
        new ViolInformer().initInformer(parentLayout,this.getDescOperation(new DescOperation()));
   ...
   /* @Override
    ...
    {
        NewViolInformer retOperation= (NewViolInformer) super.createOperation(descOperation,operation);
