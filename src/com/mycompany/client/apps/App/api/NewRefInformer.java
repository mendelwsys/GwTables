 ...
 */
public class NewRefInformer extends CreateInformerOperation
{
    public NewRefInformer(int operationId, int parentOperationId, String viewName, TypeOperation type)
    {
        super(operationId, parentOperationId, viewName, type);
    }

    protected NewRefInformer()
    {
    }

    protected IOperation getEmptyObject(DescOperation descOperation)
    {
        return new NewRefInformer();
    }
    ...
    public Canvas operate(Canvas dragTarget, IOperationContext ctx)
    {
        ...
        new RefInformer().initInformer(parentLayout,this.getDescOperation(new DescOperation()));
   ...
   /* @Override
    ...
    {
        NewRefInformer retOperation= (NewRefInformer) super.createOperation(descOperation,operation);
