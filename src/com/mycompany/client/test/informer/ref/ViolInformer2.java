 ...
 *
 */
public class ViolInformer2 implements Runnable {
...
//            styleMap.put("Comment","MyRedStyle2");
            styleMap.put("VIOL_I","MyRedStyle2");
            styleMap.put("VIOL_II","MyYellowStyle2");
...
//            styleMap.put("Comment","MyYellowStyle2");
            styleMap.put("VIOL_I","MyGreenStyle2");
            styleMap.put("VIOL_II","MyYellowStyle2");
...
//        styleMap.put("Comment",null);
        styleMap.put("VIOL_I","MyGreenStyle2");
        styleMap.put("VIOL_II","MyGreenStyle2");
            ...
            if (defValue!=null)
            {
                ...
                for (int i = 1, colNamesLength = colNames.length; i < colNamesLength; i++)
                {
                    ...
                    if (value==null || value<=0)
                        ((Map)(((Map)outValue).get(DetailViewerInfo.STYLE))).put("VIOL_II","MyGreenStyle2");
