 ...
 *
 */
public class RefInformer2 implements Runnable {
    ...
    public void initInformer(final Canvas parentCanvas,final DescOperation descInformer)
    {
        if (descInformer.get("MODE") != null && ((String) descInformer.get("MODE")).equalsIgnoreCase(GUIStateDesc.DESKTOP)) {
            setParentWindowTitle("" + ((Long) descInformer.get(CreateInformerOperation.CREATED_INFORMER_ID)).longValue(), "Отказы тех.средств: " + getDorNameByCode((Integer) descInformer.get(CreateInformerOperation.DOR_KOD)));
        ...
        final DetailViewerInfo viewInfo = new DetailViewerInfo(pr.second, pr.first,descInformer)
        {
            ...
            public void viewValues(Object _values)
            {
                ...
                {
                    if ("REF_I".equals(o) || "REF_II".equals(o))
...
//SC.say("Old record = "+oldRecord==null?null:oldRecord.toMap()+" New record = "+newRecord.toMap());
            ...
            public void setDorKod(Integer dorKod)
            {
                ...
                setCtrlCriteria();
                this.viewValues(RefInformer2.getNoDataValues().first);
...
//        viewInfo.getInformer().setHeight(300);
    ...
    */
    ...
    {
        String table= TablesTypes.REFUSES;
        String fName1 ="Отказы I кат.";
        //Задаем фильтр
...
//            styleMap.put("Comment","MyRedStyle2");
            styleMap.put("REF_I","MyRedStyle2");
            styleMap.put("REF_II","MyYellowStyle2");
            ...
            elements.add(new RefTableFunctionElem(new String[]{"REF_I","REF_II"},new FunctionDet[]{functionDet1,functionDet2},new Criterion("value", OperatorId.GREATER_THAN,5),values,viewInfo));
        }

        {
            final Map values = getNormaValues().first;
//            values.put("eventImg", "info/semafor_r.gif");
//            values.put("Comment", "Отказы I кат.");

            HashMap styleMap=new HashMap<String,String>();
//            styleMap.put("Comment","MyRedStyle2");
//            styleMap.put("REF_I","MyYellowStyle2");
            styleMap.put("REF_I","MyRedStyle2");
            styleMap.put("REF_II","MyYellowStyle2");
            ...
            values.put(DetailViewerInfo.STYLE, styleMap);
            elements.add(new RefTableFunctionElem(new String[]{"REF_I","REF_II"},new FunctionDet[]{functionDet1,functionDet2},new Criterion("value", OperatorId.GREATER_THAN, 0),values,viewInfo));
        }
...
//            styleMap.put("Comment","MyYellowStyle2");
            styleMap.put("REF_I","MyGreenStyle2");
            styleMap.put("REF_II","MyYellowStyle2");

//            styleMap.put("REF_II",null);
            ...
            elements.add(new RefTableFunctionElem(new String[]{"REF_II"},new FunctionDet[]{functionDet2}, new Criterion("value", OperatorId.GREATER_THAN, 5), values,viewInfo));
        }

        {
            final Map values = getNormaValues().first;
//            values.put("eventImg", "info/semafor_y.gif");
//            values.put("Comment", "Отказы II кат.");
            values.put("REF_I", "0");
...
//            styleMap.put("REF_II",null);
            ...
            values.put(DetailViewerInfo.STYLE, styleMap);
            elements.add(new RefTableFunctionElem(new String[]{"REF_II"},new FunctionDet[]{functionDet2}, new Criterion("value", OperatorId.GREATER_THAN, 0), values,viewInfo));
        }
    ...
    public static Pair<Map,Map<String,Pair<String, ListGridFieldType>>> getNoDataValues() {
        ...
        values.put("eventName", "Отказы ТС");
...
//        meta.put("Comment",new Pair<String, ListGridFieldType>("4",ListGridFieldType.TEXT));
        ...
        values.put("REF_I", "Нет данных");
        meta.put ("REF_I",new Pair<String, ListGridFieldType>("ОТС I",ListGridFieldType.TEXT));
        values.put("REF_II",  "Нет данных");
        meta.put("REF_II",new Pair<String, ListGridFieldType>("ОТС II",ListGridFieldType.TEXT));

        HashMap styleMap=new HashMap<String,String>();
//        styleMap.put("Comment",null);
        styleMap.put("REF_I",null);
        styleMap.put("REF_II",null);
...
//        styleMap.put("Comment",null);
        styleMap.put("REF_I","MyGreenStyle2");
        styleMap.put("REF_II","MyGreenStyle2");
            ...
            if (defValue!=null)
            {
                ...
                for (int i = 1, colNamesLength = colNames.length; i < colNamesLength; i++)
                {
                    ...
                    if (value==null || value<=0)
                        ((Map)(((Map)outValue).get(DetailViewerInfo.STYLE))).put("REF_II","MyGreenStyle2");
