 ...
 */
public class RefInformer3 implements Runnable {
...
//            styleMap.put("Comment","MyRedStyle2");
            styleMap.put("REF_I", "3");
            styleMap.put("REF_II", "2");
            ...
            if (defValue != null) {
                ...
                for (int i = 1, colNamesLength = colNames.length; i < colNamesLength; i++) {
                    ...
                    if (value == null || value <= 0)
                        ((Map) (((Map) outValue).get(DetailViewerInfo.STYLE))).put("REF_II", "1");
