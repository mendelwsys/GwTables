 ...
 *
 */
public class WarnInformer2 implements Runnable {
...
//SC.say("Old record = "+oldRecord==null?null:oldRecord.toMap()+" New record = "+newRecord.toMap());
            ...
            public void setDorKod(Integer dorKod)
            {
                if (getCtrl()!=null)
                {
                    ...
                    setCtrlCriteria();
                    this.viewValues(WarnInformer2.getNoDataValues().first);
...
//            styleMap.put("Speed","MyRedStyle2");
            styleMap.put("SPEED15","MyRedStyle2");
            styleMap.put("SPEED25","MyYellowStyle2");
...
//            values.put("Speed", "Скорость<25 (> 5-ти событий)");
            ...
            styleMap.put("SPEED15","MyGreenStyle2");
            styleMap.put("SPEED25","MyYellowStyle2");
...
//        styleMap.put("Speed",null);
        styleMap.put("SPEED15","MyGreenStyle2");
        styleMap.put("SPEED25","MyGreenStyle2");
            ...
            if (defValue!=null)
            {
                ...
                for (int i = 1, colNamesLength = colNames.length; i < colNamesLength; i++)
                {
                    ...
                    if (value==null || value<=0)
                        ((Map)(((Map)outValue).get(DetailViewerInfo.STYLE))).put("SPEED25","MyGreenStyle2");
