package com.mycompany.client.test.informer.warn;
        ...
        final DetailViewerInfo2 viewInfo = new DetailViewerInfo2(pr.second, pr.first, descInformer) {
            ...
            public void viewValues(Object _values) {
              /*  Map values =(Map)_values;
                ...
                {
                    if ("SPEED15".equals(o) || "SPEED25".equals(o))
            ...
            public void performAnalysisOnUpdate(Pair<Record, Record> data) {
                ...
                // consoleLog("Old record = "+oldRecord==null?null:oldRecord.toMap()+" New record = "+newRecord.toMap());
//SC.say("Old record = "+oldRecord==null?null:oldRecord.toMap()+" New record = "+newRecord.toMap());
                ...
                for (int i = 0; i < s.length; i++) {
                    ...
                    // consoleLog("Old val = "+oldValue+" New val = "+newValue);
            ...
            public void setDorKod(Integer dorKod) {
                if (getCtrl() != null) {
                    ...
                    setCtrlCriteria();
                    this.viewValues(WarnInformer3.getNoDataValues().first);
...
//            styleMap.put("Speed","MyRedStyle2");
            styleMap.put("SPEED15", "3");
            styleMap.put("SPEED25", "2");
...
//            values.put("Speed", "Скорость<15");
            ...
            HashMap styleMap = new HashMap<String, String>();
//            styleMap.put("Speed","MyRedStyle2");
//            styleMap.put("SPEED15","MyYellowStyle2");
            styleMap.put("SPEED15", "3");
            styleMap.put("SPEED25", "2");
...
//            values.put("Speed", "Скорость<25 (> 5-ти событий)");
            values.put("SPEED15", "0");

            HashMap styleMap = new HashMap<String, String>();
            //styleMap.put("Speed","MyYellowStyle2");
            styleMap.put("SPEED15", "1");
            styleMap.put("SPEED25", "2");
...
//        meta.put("Speed",new Pair<String, ListGridFieldType>("4",ListGridFieldType.TEXT));
        ...
        meta.put("SPEED15", new Pair<String, ListGridFieldType>("Скор <15", ListGridFieldType.TEXT));
        values.put("SPEED25", "Нет данных");
        meta.put("SPEED25", new Pair<String, ListGridFieldType>("Скор <25", ListGridFieldType.TEXT));
...
//        meta.put("Speed",new Pair<String, ListGridFieldType>("4",ListGridFieldType.TEXT));
        ...
        values.put("SPEED15", "0");
        meta.put("SPEED15", new Pair<String, ListGridFieldType>("Скор <15", ListGridFieldType.TEXT));
        values.put("SPEED25", "0");
        meta.put("SPEED25", new Pair<String, ListGridFieldType>("Скор <25", ListGridFieldType.TEXT));

        HashMap styleMap = new HashMap<String, String>();
//        styleMap.put("Speed",null);
        styleMap.put("SPEED15", "1");
        styleMap.put("SPEED25", "1");
...
//
//            values.put("eventImg", "info/semafor_g.gif");
//            meta.put("eventImg",new Pair<String, ListGridFieldType>("Дор",ListGridFieldType.IMAGE));
//            values.put("period", eventName + "<br><b>" + dorName + "," + predId);
//            meta.put("period",new Pair<String, ListGridFieldType>("Инф",ListGridFieldType.TEXT));
...
//                        values.put("eventImg", "info/semafor_r.gif");
//                        values.put("place", place1);
//                        values.put(DetailViewerInfo.STYLE, new Pair<String,String>("eventImg","MyRedStyle2"));
//                    }
//                    else
//                    {
//                        values.put("eventImg", "info/semafor_g.gif");
            ...
            if (defValue != null) {
                ...
                for (int i = 1, colNamesLength = colNames.length; i < colNamesLength; i++) {
                    ...
                    if (value == null || value <= 0)
                        ((Map) (((Map) outValue).get(DetailViewerInfo.STYLE))).put("SPEED25", "1");
