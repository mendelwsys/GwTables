package com.mycompany.client.test.t9;
 ...
 */
    ...
    public class GridCellWidgetsSample implements Runnable
    {
        ...
        public void run()
        {
            ...
            //countryGrid.setCanAddSummaryFields(true);//Это функция формирования вычисляемого поля для каждой строки
