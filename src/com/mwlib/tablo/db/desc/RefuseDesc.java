 ...
 */
public class RefuseDesc extends BaseTableDesc
{
...
//                        }
                    ...
                    new SimpleField(TablesTypes.COMMENT,"Проявление отказа"),
                    ...
                    */
                    ...
                    new SimpleField(TablesTypes.ID_KIND,"Тип отказа",ListGridFieldType.INTEGER.toString(),false)
                    {
                        public Object getS(ColumnHeadBean[] column, Map tuple, Map<String, Object> _outTuple) throws FieldException
                        {
...
//    private void fillTupleByPreds(Map tuple, Map<String, Object> hs) {
//        final Object o_vid_id = tuple.get(TablesTypes.VID_ID);
//        if (Integer.valueOf(TablesTypes.Z_ID_SERVAL).equals(o_vid_id))
//        {
...
//    }
    ...
    private static FieldTranslator desc=new SimpleField(TablesTypes.ID_KIND,"Тип отказа",ListGridFieldType.INTEGER.toString(),false);

    public RefuseDesc(boolean test) {
        super(test);
    }

    public static Object getRowStyle(ColumnHeadBean[] column,Map tuple, Map<String, Object> _outTuple) throws FieldException
    {
        Integer rv=(Integer)tuple.get(TablesTypes.ID_KIND);
