package com.mwlib.tablo.servlets.pred;
 ...
 */
public class DataServletDCons extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        try
        {
            ...
            updater = new ServerUpdaterT2(ConsolidateEventProviderTImpl2.getConsolidateProvider(dsName, mapper.getNames(), test), ICliProviderFactoryImpl.getCliManagerInstance(),new DefaultCacheFactory());
