 ...
 * To change this template use File | Settings | File Templates.
 */
public class ViolationT extends BaseTable
{
    private FieldTranslator[] fieldTranslator=new FieldTranslator[]
    {
                    ...
                    new SimpleField("COMMENT","Проявление нарушения"),
                    ...
                    new AField("CRDURL","Карточка")
                    {
                        ...
                        public Object getS(ColumnHeadBean[] column, Map tuple, Map<String, Object> _outTuple)
                        {
                            ...
                            if (id!=null && id.length()>0)
                            {
                                ...
                                return "http://k_host/TabloReport2/KXXXX/ShowOriginalCard?DorKod="+dor2id[0]+"&EventId="+dor2id[1]+"&Type=Kasat";
                            }
                            return "";
    ...
    protected ViolationT(boolean test) {
        super(test);
    }
    ...
    public static BaseTable getInstance(boolean test) throws Exception
    {
        ...
        if (inst!=null)
            return inst;
        return inst=new ViolationT(test);
    }
    ...
    protected Pair<ColumnHeadBean[], Map[]> getDbTable(Map mapParams, Map<String, Object> outParams) throws Exception
    {
        ...
        Pair<ColumnHeadBean[], Map[]> resVal = FillFromDb._getDbTable(GET_W_VIOLATION, valMap, outParams, new FillFromDb.IRowOperation()
        {
