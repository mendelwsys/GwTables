 ...
 * Date: 25.09.14
 * Time: 12:37
 * Сервлет подкачики данных для исторических таблиц клиентов (С имплементацией самых разных тестов)
 * на базе DataServletWK
 */
public class DataServletH extends HttpServlet {
    ...
    public void init() throws ServletException
    {
        ...
        try
        {
            ...
            updater = new ServerUpdaterUNEW(eventProvider, IDerbyCliProviderFactoryImpl.getCliManagerInstance(),
            new ICacheFactory()
            {
