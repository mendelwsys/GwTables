...
import com.mwlib.tablo.derby.oindex.OIndexLoader;
 ...
 */
public class OIndxEventProviderTImpl
        implements IEventProvider
{
     ...
     * @throws Exception -
     */
    public OIndxEventProviderTImpl(IAnalisysDesc desc, String dsName, String[] loaderTypes, boolean test, IMetaProvider _metaProvider) throws Exception {
        this.desc = desc;
        this.dsName = dsName;
        this.test=test;
...
//                e.printStackTrace();
    ...
    private void initMeta() throws Exception
    {
            ...
            {//Инициализация метапровайдера
                ...
                loader = new OIndexLoader(loaderTypes,dsName,test);
                wasInit=true;
            }
    }

    public static String getConsTableType() {
        return TablesTypes.OINDX;
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test) throws Exception
    {
        ...
        return new OIndxEventProviderTImpl(desc,dsName,loaderTypes,test,null);
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test,IMetaProvider metaProvider) throws Exception
    {
        ...
        return new OIndxEventProviderTImpl(desc,dsName,loaderTypes,test,metaProvider);
    }


    public static IAnalisysDesc getDesc() throws Exception {
        IAnalisysDesc desc=new NNodeBuilder().xml2Desc(OIndxXML.xml);
