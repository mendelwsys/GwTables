...
import com.mwlib.tablo.derby.warnact.Consolidator4WarnACTDataLoader;
 ...
 * Date: 26.08.15
 * Time: 14:39
 * провайдер для активных предупрждений
 */
public class WarnActEventProviderTImpl
        implements IEventProvider
{
     ...
     * @throws Exception -
     */
    protected WarnActEventProviderTImpl(IAnalisysDesc desc, String dsName, String[] loaderTypes, boolean test, IMetaProvider _metaProvider) throws Exception {
        this.desc = desc;
        this.dsName = dsName;
        this.test=test;
...
//                metaProvider.addColumnByName(TablesTypes.STATEPLACES,new ColumnHeadBean("NUM", "NUM", ListGridFieldType.INTEGER.toString(),-4));
                ...
                loader = new Consolidator4WarnACTDataLoader(loaderTypes,dsName,test); //TODO Абстрагировать лоадер????
                wasInit=true;
            }
    }
    ...
    {
        return TablesTypes.STATEWARNACT;
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test) throws Exception
    {
        ...
        return new WarnActEventProviderTImpl(desc,dsName,loaderTypes,test,null);
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test,IMetaProvider metaProvider) throws Exception
    {
        ...
        return new WarnActEventProviderTImpl(desc,dsName,loaderTypes,test,metaProvider);
    }

    public static IAnalisysDesc getDesc() throws Exception {
        IAnalisysDesc desc=new NNodeBuilder().xml2Desc(WarnACTXML.xml);
