...
import com.mwlib.tablo.derby.places.Consolidator4PlaceDataLoader;
 ...
 * Date: 01.10.14
 * Time: 14:39
 * провайдер для ConsolidatorLoader2
 */
public class PlacesEventProviderTImpl
        implements IEventProvider
{
     ...
     * @throws Exception -
     */
    protected PlacesEventProviderTImpl(IAnalisysDesc desc, String dsName,String oraName, String[] loaderTypes, boolean test,IMetaProvider _metaProvider) throws Exception {
        this.desc = desc;
        this.dsName = dsName;
...
//                metaProvider.addColumnByName(TablesTypes.STATEPLACES,new ColumnHeadBean("NUM", "NUM", ListGridFieldType.INTEGER.toString(),-4));
                ...
                loader = new Consolidator4PlaceDataLoader(loaderTypes,dsName,oraName,test); //TODO Абстрагировать лоадер????
                wasInit=true;
            }
    }
    ...
    {
        return TablesTypes.STATEPLACES;
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String oraName,String[] loaderTypes,boolean test) throws Exception
    {
        IAnalisysDesc desc = getDesc();
        return new PlacesEventProviderTImpl(desc,dsName,oraName,loaderTypes,test,null);
    }

    public static IEventProvider getConsolidateProvider(String dsName,String oraName,String[] loaderTypes,boolean test,IMetaProvider metaProvider) throws Exception
    {
        ...
        return new PlacesEventProviderTImpl(desc,dsName,oraName,loaderTypes,test,metaProvider);
    }

    public static IAnalisysDesc getDesc() throws Exception {
        IAnalisysDesc desc=new NNodeBuilder().xml2Desc(PlacesXML.xml);
