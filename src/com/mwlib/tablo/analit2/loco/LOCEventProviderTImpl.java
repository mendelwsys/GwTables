...
import com.mwlib.tablo.derby.loco.ConsolidatorLOC;
 ...
 * Date: 01.10.14
 * Time: 14:39
 * провайдер для локомотивов
 */
public class LOCEventProviderTImpl
        implements IEventProvider
{
    ...
    {
        return new SimpleKeyGenerator(new String[]{"DOR_KOD_NAME_P_ID"},new INm2Ix()
        {
            @Override
            public Map<String, Integer> getColName2Ix()
            {
                Map<String, Integer> rv = new HashMap<String, Integer>();
                rv.put("DOR_KOD_NAME_P_ID",0);
                return rv;
            }
     ...
     * @throws Exception -
     */
    public LOCEventProviderTImpl(IAnalisysDesc desc, String dsName, String[] loaderTypes, boolean test, IMetaProvider _metaProvider) throws Exception {
        this.desc = desc;
        this.dsName = dsName;
        this.test=test;
...
//                resMap.put("NDAY",tuple.get("NDAY"));//TODO !!!!подпорка!!!!
            }
...
//                e.printStackTrace();
    ...
    private void initMeta() throws Exception
    {
            ...
            {//Инициализация метапровайдера
                ...
                metaProvider.addColumnByName(getConsTableType(),new ColumnHeadBean(TablesTypes.DATATYPE_ID, TablesTypes.DATATYPE_ID, DbUtils.translate2AttrType("INTEGER"),-1));
                ...
                loader = new ConsolidatorLOC(loaderTypes,dsName,test);
                wasInit=true;
            }
    }

    public static String getConsTableType() {
        return TablesTypes.LOC_DATA;
    }
...
//            }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test) throws Exception
    {
        ...
        return new LOCEventProviderTImpl(desc,dsName,loaderTypes,test,null);
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test,IMetaProvider metaProvider) throws Exception
    {
        ...
        return new LOCEventProviderTImpl(desc,dsName,loaderTypes,test,metaProvider);
    }


    public static IAnalisysDesc getDesc() throws Exception {
        IAnalisysDesc desc=new NNodeBuilder().xml2Desc(LOCXML.xml);
