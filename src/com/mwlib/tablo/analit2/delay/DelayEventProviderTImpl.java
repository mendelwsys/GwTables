...
import com.mwlib.tablo.derby.delay.ConsolidatorDelay;
 ...
 */
public class DelayEventProviderTImpl
        implements IEventProvider
{
    ...
    {
        return new SimpleKeyGenerator(new String[]{"DEL_ID"},new INm2Ix()
        {
            @Override
     ...
     * @throws Exception -
     */
    public DelayEventProviderTImpl(IAnalisysDesc desc, String dsName, String[] loaderTypes, boolean test,IMetaProvider metaProvider) throws Exception {
        this.desc = desc;
        this.dsName = dsName;
        this.test=test;
...
//                e.printStackTrace();
    ...
    private void initMeta() throws Exception
    {
            ...
            {//Инициализация метапровайдера
                ...
                loader = new ConsolidatorDelay(loaderTypes,dsName,test);
                wasInit=true;
            }
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test,IMetaProvider metaProvider) throws Exception
    {
        ...
        return new DelayEventProviderTImpl(desc,dsName,loaderTypes,test,metaProvider);
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test) throws Exception
    {
        ...
        return new DelayEventProviderTImpl(desc,dsName,loaderTypes,test,null);
    }

    public static IAnalisysDesc getDesc() throws Exception {
        IAnalisysDesc desc=new NNodeBuilder().xml2Desc(DelayXML.xml);
