...
import com.mwlib.tablo.derby.winrep.Consolidator4WinRepDataLoader;
 ...
 */
public class WinRepEventProviderTImpl
        implements IEventProvider
{
     ...
     * @throws Exception -
     */
    protected WinRepEventProviderTImpl(IAnalisysDesc desc, String dsName, String[] loaderTypes, boolean test, IMetaProvider _metaProvider) throws Exception {
        this.desc = desc;
        this.dsName = dsName;
        this.test=test;
...
//                metaProvider.addColumnByName(TablesTypes.STATEPLACES,new ColumnHeadBean("NUM", "NUM", ListGridFieldType.INTEGER.toString(),-4));
                ...
                loader = new Consolidator4WinRepDataLoader(loaderTypes,dsName,test); //TODO Абстрагировать лоадер????
                wasInit=true;
            }
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test) throws Exception
    {
        ...
        return new WinRepEventProviderTImpl(desc,dsName,loaderTypes,test,null);
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test,IMetaProvider metaProvider) throws Exception
    {
        ...
        return new WinRepEventProviderTImpl(desc,dsName,loaderTypes,test,metaProvider);
    }

    public static IAnalisysDesc getDesc() throws Exception {
        IAnalisysDesc desc=new NNodeBuilder().xml2Desc(WinRepXML.xml);
