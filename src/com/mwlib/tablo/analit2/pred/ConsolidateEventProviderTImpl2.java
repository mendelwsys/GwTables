...
import com.mwlib.tablo.derby.pred.ConsolidatorLoader2;
 ...
 */
public class ConsolidateEventProviderTImpl2
        implements IEventProvider
{
     ...
     * @throws Exception -
     */
    public ConsolidateEventProviderTImpl2(IAnalisysDesc desc,String dsName,String[] loaderTypes, boolean test,IMetaProvider _metaProvider) throws Exception {
        this.desc = desc;
        this.dsName = dsName;
        this.test=test;
...
//                e.printStackTrace();
    ...
    private ConsolidatorLoader2 loader;
...
//                metaProvider.addColumn2AllTypes(new ColumnHeadBean(TablesTypes.ACTUAL, TablesTypes.ACTUAL, ListGridFieldType.INTEGER.toString(), -3));
                ...
                loader = new ConsolidatorLoader2(loaderTypes,dsName,test);
                wasInit=true;
            }
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test) throws Exception
    {
        ...
        return new ConsolidateEventProviderTImpl2(desc,dsName,loaderTypes,test,null);
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test,IMetaProvider metaProvider) throws Exception
    {
        ...
        return new ConsolidateEventProviderTImpl2(desc,dsName,loaderTypes,test,metaProvider);
    }
