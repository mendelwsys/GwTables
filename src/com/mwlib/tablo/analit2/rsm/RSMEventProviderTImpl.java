...
import com.mwlib.tablo.derby.rsm.ConsolidatorRSM;
 ...
 */
public class RSMEventProviderTImpl
        implements IEventProvider
{
    ...
    {
        return new SimpleKeyGenerator(new String[]{"STATE_ID"},new INm2Ix()
        {
            @Override
     ...
     * @throws Exception -
     */
    public RSMEventProviderTImpl(IAnalisysDesc desc, String dsName, String[] loaderTypes, boolean test, IMetaProvider _metaProvider) throws Exception {
        this.desc = desc;
        this.dsName = dsName;
        this.test=test;
    ...
    public Pair<IMetaProvider,Map[]> getUpdateTable(Map<String, ParamVal> mapParams, Map<String, Object> outParams) throws Exception
    {
        ...
        for (Map tuple : data)
        {
            ...
            if (resMap==null)
            {
                ...
                resMap.put("NPP",tuple.get("NPP"));//TODO !!!!подпорка!!!!
            }
...
//                e.printStackTrace();
    ...
    private void initMeta() throws Exception
    {
            ...
            {//Инициализация метапровайдера
                ...
                loader = new ConsolidatorRSM(dsName,test);
                wasInit=true;
            }
    }

    public static String getConsTableType() {
        return TablesTypes.RSM_DATA;
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test) throws Exception
    {
        ...
        return new RSMEventProviderTImpl(desc,dsName,loaderTypes,test,null);
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test,IMetaProvider metaProvider) throws Exception
    {
        ...
        return new RSMEventProviderTImpl(desc,dsName,loaderTypes,test,metaProvider);
    }


    public static IAnalisysDesc getDesc() throws Exception {
        IAnalisysDesc desc=new NNodeBuilder().xml2Desc(RSMXML.xml);
