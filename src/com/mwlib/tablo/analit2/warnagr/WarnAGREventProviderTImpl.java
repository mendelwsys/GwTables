...
import com.mwlib.tablo.derby.warnagr.WarnAGRLoader;
 ...
 */
public class WarnAGREventProviderTImpl
        implements IEventProvider
{
    ...
    {
        return new SimpleKeyGenerator(new String[]{"DOR_KOD"},new INm2Ix()
        {
            @Override
     ...
     * @throws Exception -
     */
    public WarnAGREventProviderTImpl(IAnalisysDesc desc, String dsName, String[] loaderTypes, boolean test, IMetaProvider _metaProvider) throws Exception {
        this.desc = desc;
        this.dsName = dsName;
        this.test=test;
...
//                e.printStackTrace();
    ...
    private void initMeta() throws Exception
    {
            ...
            {//Инициализация метапровайдера
                ...
                loader = new WarnAGRLoader(loaderTypes,dsName,test);
                wasInit=true;
            }
    }

    public static String getConsTableType() {
        return TablesTypes.STATEWARNAGR;
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test) throws Exception
    {
        ...
        return new WarnAGREventProviderTImpl(desc,dsName,loaderTypes,test,null);
    }
    ...
    public static IEventProvider getConsolidateProvider(String dsName,String[] loaderTypes,boolean test,IMetaProvider metaProvider) throws Exception
    {
        ...
        return new WarnAGREventProviderTImpl(desc,dsName,loaderTypes,test,metaProvider);
    }


    public static IAnalisysDesc getDesc() throws Exception {
        IAnalisysDesc desc=new NNodeBuilder().xml2Desc(WarnAGRXML.xml);
