package com.mwlib.tablo.derby.warnv;
 ...
 */
public class Consolidator4WarnVDataLoader implements IDataLoader
{
    ...
    public Consolidator4WarnVDataLoader(String[] loaderTypes, String dsName, boolean test)
    {
        this.test=test;
...
//TODO !!!!проверить политику заполнения кеша данных после получения консолидационных таблиц!!!!
            ...
            String time=sdf2.format(dt);
                ...
                {//Ограничения по скоростям 50
                    String addStringFilter="tbl.V<=50 and tbl.V>40 and tbl.TIM_BEG <= TIMESTAMP('"+stringDate+"', '"+time+"') and TIMESTAMP('"+stringDate+"', '"+time+"') <= tbl.TIM_OTM";
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("A", "50");
                    sqlConsolidator(conn, outTuples, tblName, addStringFilter, addInParams);
                ...
                {//Ограничения по скоростям 50
                    String addStringFilter="tbl.V<=60 and tbl.V>50 and tbl.TIM_BEG <= TIMESTAMP('"+stringDate+"', '"+time+"') and TIMESTAMP('"+stringDate+"', '"+time+"') <= tbl.TIM_OTM";
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("A", "60");
                    sqlConsolidator(conn, outTuples, tblName, addStringFilter, addInParams);
                ...
                {//Ограничения по скоростям 50
                    String addStringFilter="tbl.V>60 and tbl.TIM_BEG <= TIMESTAMP('"+stringDate+"', '"+time+"') and TIMESTAMP('"+stringDate+"', '"+time+"') <= tbl.TIM_OTM";
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("A", "OTHER");
                    sqlConsolidator(conn, outTuples, tblName, addStringFilter, addInParams);
