package com.mwlib.tablo.derby.warnact;
 ...
 */
public class Consolidator4WarnACTDataLoader implements IDataLoader
{
    ...
    public Consolidator4WarnACTDataLoader(String[] loaderTypes, String dsName, boolean test)
    {
        this.test=test;
...
//TODO !!!!проверить политику заполнения кеша данных после получения консолидационных таблиц!!!!
            ...
            String time=sdf2.format(dt);
...

                {
                    ...
                    String addStringFilter="tbl.TIM_BEG <= TIMESTAMP('"+stringDate+"', '"+time+"') and TIMESTAMP('"+stringDate+"', '"+time+"') <= tbl.TIM_OTM";
                ...
                {//Ограничения по скоростям 15
                    String addStringFilter="tbl.V<=15 and tbl.TIM_BEG <= TIMESTAMP('"+stringDate+"', '"+time+"') and TIMESTAMP('"+stringDate+"', '"+time+"') <= tbl.TIM_OTM";
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("A", "15");
                ...
                {//Ограничения по скоростям 25
                    String addStringFilter="tbl.V<=25 and tbl.V>15 and tbl.TIM_BEG <= TIMESTAMP('"+stringDate+"', '"+time+"') and TIMESTAMP('"+stringDate+"', '"+time+"') <= tbl.TIM_OTM";
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("A", "25");
                ...
                {//Ограничения по скоростям 40
                    String addStringFilter="tbl.V<=40 and tbl.V>25 and tbl.TIM_BEG <= TIMESTAMP('"+stringDate+"', '"+time+"') and TIMESTAMP('"+stringDate+"', '"+time+"') <= tbl.TIM_OTM";
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("A", "40");
...

                {
                    ...
                    String addStringFilter="tbl.FIXED_END_DATE=0 and tbl.TIM_BEG <= TIMESTAMP('"+stringDate+"', '"+time+"') and TIMESTAMP('"+stringDate+"', '"+time+"') <= tbl.TIM_OTM";
                ...
                {
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("A", "PLONG");
                    String addStringFilter="tbl.VID_NAME='П' and tbl.FIXED_END_DATE=0 and tbl.TIM_BEG <= TIMESTAMP('"+stringDate+"', '"+time+"') and TIMESTAMP('"+stringDate+"', '"+time+"') <= tbl.TIM_OTM";
                ...
                {
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("A", "ELONG");
                    String addStringFilter="tbl.VID_NAME='Э' and tbl.FIXED_END_DATE=0 and tbl.TIM_BEG <= TIMESTAMP('"+stringDate+"', '"+time+"') and TIMESTAMP('"+stringDate+"', '"+time+"') <= tbl.TIM_OTM";
                ...
                {
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("A", "HLONG");
                    String addStringFilter="tbl.VID_NAME='Ш' and tbl.FIXED_END_DATE=0 and tbl.TIM_BEG <= TIMESTAMP('"+stringDate+"', '"+time+"') and TIMESTAMP('"+stringDate+"', '"+time+"') <= tbl.TIM_OTM";
