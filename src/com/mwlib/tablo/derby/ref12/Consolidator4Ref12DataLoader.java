package com.mwlib.tablo.derby.ref12;
 ...
 */
public class Consolidator4Ref12DataLoader implements IDataLoader
{
    ...
    public Consolidator4Ref12DataLoader(String[] loaderTypes, String dsName, boolean test)
    {
        this.test=test;
...
//                    sqlReamerConsolidator(conn, outTuples, tblName,addInParams);
                    String addStringFilter="tbl.ID_KIND IN (1,2) and tbl.ND >= TIMESTAMP('"+stringDate+"', '00:00:00')";
                ...
                {//Отказы тех. средств с начала текущего дня устраненные
                    String addStringFilter="tbl.ID_KIND IN (1,2) and tbl.ND >= TIMESTAMP('"+stringDate+"', '00:00:00') and tbl.KD<TIMESTAMP('"+stringDate+"', '"+time+"') and tbl.ND<=tbl.KD";
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("A", "TOT_D");
                    sqlConsolidator(conn, outTuples, tblName, addStringFilter, addInParams);
...
//            if (false)
            {//Отказы тех. средств
                ...
                {//Отказы тех. средств с начала текущего дня устраненные более часа
                    String addStringFilter="tbl.ID_KIND IN (1,2) and tbl.ND >= TIMESTAMP('"+stringDate+"', '00:00:00') and tbl.KD<TIMESTAMP('"+stringDate+"', '"+time+"') and tbl.ND<=tbl.KD and {fn timestampdiff(SQL_TSI_MINUTE,tbl.ND,tbl.KD)}>60";
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("A", "LONG_D");
                    sqlConsolidator(conn, outTuples, tblName, addStringFilter, addInParams);
                ...
                {//Отказы тех. средств с начала текущего дня НЕ устраненные
                    String addStringFilter="tbl.ID_KIND IN (1,2) and tbl.ND >= TIMESTAMP('"+stringDate+"', '00:00:00') and (tbl.KD is null or tbl.KD>TIMESTAMP('"+stringDate+"', '"+time+"') or tbl.ND>tbl.KD)";
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("A", "ACT_TOT_D");
                    sqlConsolidator(conn, outTuples, tblName, addStringFilter, addInParams);
                ...
                {//Отказы тех. средств с начала текущего дня НЕ устраненные более часа
                    String addStringFilter="tbl.ID_KIND IN (1,2) and tbl.ND >= TIMESTAMP('"+stringDate+"', '00:00:00') and (tbl.KD is null or tbl.KD>TIMESTAMP('"+stringDate+"', '"+time+"') or tbl.ND>tbl.KD) and " +
                            "( {fn timestampdiff(SQL_TSI_MINUTE,tbl.ND,tbl.KD)}>60 or {fn timestampdiff(SQL_TSI_MINUTE,tbl.ND,TIMESTAMP('"+stringDate+"', '"+time+"'))}>60)";
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("A", "ACT_LONG_D");
                    sqlConsolidator(conn, outTuples, tblName, addStringFilter, addInParams);
                ...
                {
                    Map<String,Object> addInParams= new HashMap<String,Object>();
                    addInParams.put("EVENT_TYPE",tblName+"#ACT_TOT_ALL");
                    String addStringFilter="tbl.ID_KIND IN (1,2) and (tbl.KD is null or tbl.KD>TIMESTAMP('"+stringDate+"', '"+time+"') or tbl.ND>tbl.KD)";
                    sqlConsolidator(conn, outTuples, tblName, addStringFilter, addInParams);
